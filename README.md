<h1>Hi there! 👋 I'm currently working on Webdev/Personal Projects, and an aspiring Linux Dev</h1>

I am going to be using this repository for notes and particularly interesting information I come across.
My first project is actually a text adventure game within python using functions and call backs to arrange different if and else statements.
